...
public class GraphDemoFrame extends JFrame {
    ...
    private JButton buttonFindWays;
    private JSpinner spinnerStart;
    private JSpinner spinnerFinish;
    private JButton buttonFindParallelWays;
    ...
    public GraphDemoFrame() {
        ...
        buttonFindWays.addActionListener(e -> {
            ArrayList<Integer> path = new ArrayList<>();
            ArrayList<ArrayList<Integer>> listOfAllPaths = new ArrayList<>();
            boolean[] visited = new boolean[graph.vertexCount()];

            int start = (int) spinnerStart.getValue();
            int finish = (int) spinnerFinish.getValue();

            showSystemOut(() -> {
                GraphAlgorithms.findWays(graph, start, finish, visited, path, listOfAllPaths);
            });

            try {
                panelGraphPainter.paint(dotToSvg(GraphUtils.toDotWithPaths(graph, listOfAllPaths)));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        });
        buttonFindParallelWays.addActionListener(e -> {
            ArrayList<Integer> path = new ArrayList<>();
            ArrayList<ArrayList<Integer>> listOfAllPaths = new ArrayList<>();
            boolean[] visited = new boolean[graph.vertexCount()];
            ...
            if (GraphAlgorithms.isThisAnEdge(graph, start, finish)) {
                showSystemOut(() -> {
                    GraphAlgorithms.findParallelWays(graph, start, finish, visited, path, listOfAllPaths);
                });
                try {
                    panelGraphPainter.paint(dotToSvg(GraphUtils.toDotWithPaths(graph, listOfAllPaths)));
                } catch (IOException ex) {
                ...
                showSystemOut(() -> {
                    System.out.println("Введенные точки не образуют ребро");
                });
            }
        });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel4.add(panel7, new GridConstraints(5, 0, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        buttonFindWays = new JButton();
        buttonFindWays.setText("Найти пути");
        panel7.add(buttonFindWays, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        buttonFindParallelWays = new JButton();
        buttonFindParallelWays.setText("Найти обходные пути");
        panel7.add(buttonFindParallelWays, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        spinnerStart = new JSpinner();
        panel4.add(spinnerStart, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(60, -1), null, 0, false));
        spinnerFinish = new JSpinner();
        panel4.add(spinnerFinish, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(60, -1), null, 0, false));
        final JLabel label2 = new JLabel();
        label2.setText("Начальная точка");
        panel4.add(label2, new GridConstraints(3, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label3 = new JLabel();
        label3.setText("Финальная точка");
        panel4.add(label3, new GridConstraints(4, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
